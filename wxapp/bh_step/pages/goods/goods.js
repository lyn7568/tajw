...
Page({
    ...
    onLoad: function(t) {
        if (this.setData({
            ...
            var e = decodeURIComponent(t.scene).split("_");
            wx.setStorageSync("parent_id", e[0]), wx.setStorageSync("goods_id", e[1]), wx.setStorageSync("share_tpye", 4), 
            this.data.id = e[1], this.setData({
                is_qrcode: !0
            });
        }
