        ...
        t.util.request({
            ...
            success: function(a) {
                ...
                if (!1 !== g) {
                    ...
                    e.totalnum++, e.options_data[v.option_id].num ? e.options_data[v.option_id].num++ : e.options_data[v.option_id].num = 1, 
        ...
        t.util.request({
            ...
            success: function(a) {
                ...
                if (!1 !== r) {
                    ...
                    i.totalnum > 0 && i.totalnum--, i.options_data[l.option_id].num ? i.options_data[l.option_id].num-- : i.options_data[l.option_id].num = 0, 
