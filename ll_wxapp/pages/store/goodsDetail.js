    ...
    onPlus: function(a) {
        ...
        if (1 == i.data.cart.is_buysvip && (e = 1), "selectSvip" == a.detail.from) {
            ...
            if (1 == i.data.goodsActive.svip_buy_show && 1 != i.data.cart.is_buysvip && i.data.cart.svip_buy_show >= 1) {
                var p = 0, v = 0;
                return i.data.goodsActive.activeOption ? (p = v = i.data.goodsActive.activeOption.price, 
                i.data.goodsActive.activeOption.svip_price > 0 && (p = i.data.goodsActive.activeOption.svip_price), 
                i.data.goodsActive.activeOption.origin_price > 0 && (v = i.data.goodsActive.activeOption.origin_price)) : (p = i.data.goodsActive.svip_price, 
                v = i.data.goodsActive.origin_price), i.data.buySvipInfo.goods = {
                    svip_price: p,
                    price: v,
                    goods_id: n,
                    option_id: d
        ...
        t.util.request({
            ...
            success: function(a) {
                ...
                u.goods_id == o.id && (o.totalnum++, o.options_data[u.option_id].num ? o.options_data[u.option_id].num++ : o.options_data[u.option_id].num = 1, 
                u.option_id != o.activeOptionId || 1 != o.is_options && 1 != o.is_attrs || (o.activeOption.num = o.options_data[u.option_id].num));
                var e = {
                    cart: a.message.cart,
                    goodsActive: o,
                    goodsDetail: o
                };
                i.setData(e), i.onCalculate();
            }
        });
    },
    ...
    onMinus: function(a) {
        ...
        t.util.request({
            ...
            success: function(a) {
                if ((a = a.data.message).errno) return t.util.toast(a.message), !1;
                var o = i.data.goodsActive;
                c.goods_id == o.id && (o.totalnum > 0 && o.totalnum--, o.options_data[c.option_id].num ? o.options_data[c.option_id].num-- : o.options_data[c.option_id].num = 0, 
                ...
                a.message.cart.num || (e.showCartDetail = !1), i.setData(e), i.onCalculate();
            }
        });
    },
    onSubmit: function() {
      ...
      var i = "pages/order/create/create?sid=" + a.data.store.id + "&is_buysvip=" + a.data.cart.is_buysvip;
