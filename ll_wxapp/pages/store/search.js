...
Page({
    ...
    onLoad: function(a) {
        var e = this;
        e.data.sid = a.sid, a.pindan_id > 0 && (e.data.pindan_id = a.pindan_id), t.util.request({
            ...
            success: function(a) {
                ...
                if (i && (e.data.searchHistory = i), e.setData({
                    ...
                    if (s) {
                        var d = s.pages_store_goods.navigationBarBackgroundColor;
    ...
    onChangeCart: function(a) {
        ...
        if (1 == e.data.cart.is_buysvip && (o = 1), "selectSvip" == a.detail.from) {
            ...
            if (!1 !== p) {
                ...
                if (d = u.id, r = u.activeOptionId, !u.total && "plus" == i) return t.util.toast("库存不足"), 
                !1;
            }
            if ("plus" == i && 1 == e.data.goodsActive.svip_buy_show && 1 != e.data.cart.is_buysvip && e.data.cart.svip_buy_show >= 1) {
                var g = 0, v = 0;
                return e.data.goodsActive.activeOption ? (g = v = e.data.goodsActive.activeOption.price, 
                e.data.goodsActive.activeOption.svip_price > 0 && (g = e.data.goodsActive.activeOption.svip_price), 
                e.data.goodsActive.activeOption.origin_price > 0 && (v = e.data.goodsActive.activeOption.origin_price)) : (g = e.data.goodsActive.svip_price, 
                v = e.data.goodsActive.origin_price), e.data.buySvipInfo.goods = {
                    svip_price: g,
                    price: v,
                    goods_id: d,
                    option_id: r,
        ...
        t.util.request({
            ...
            success: function(a) {
                ...
                if (!1 !== p) {
                    ...
                    "plus" == i ? s.totalnum++ : s.totalnum > 0 && s.totalnum--, s.options_data[l.option_id].num ? "plus" == i ? s.options_data[l.option_id].num++ : s.options_data[l.option_id].num-- : s.options_data[l.option_id].num = "plus" == i ? 1 : 0, 
                    1 != s.is_options && 1 != s.is_attrs || (s.activeOption.num = s.options_data[l.option_id].num), 
