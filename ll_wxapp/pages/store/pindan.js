    ...
    onTakePindan: function() {
        ...
        a.util.request({
            ...
            success: function(n) {
                ...
                !1;
                a.util.jump2url("/pages/store/goods?sid=" + t.data.sid + "&pindan_id=" + t.data.pindan_id);
            }
        });
    },
    onGiveUp: function(t) {
            ...
            success: function(t) {
                t.confirm ? a.util.request({
                    ...
                    success: function(t) {
                        ...
                        if (i.errno) return -1e3 == i.errno ? (a.util.toast("取消拼单成功", "/pages/store/goods?sid=" + n.data.sid, 1e3), 
