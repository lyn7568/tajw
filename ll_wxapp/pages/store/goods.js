...
Page({
    ...
    onLoad: function(a) {
        ...
        t.util.request({
            ...
            success: function(a) {
                var o = a.data.global, a = a.data.message.message;
                if (e.data.store = a.store, a.store.is_in_business_hours || (e.data.rest = !0), 
                a.store.activity.num || (e.data.activityStatus = !0), e.setData({
                    store: a.store,
                    coupon: a.coupon,
                ...
                wx.setNavigationBarTitle({
                    ...
                    d.data.length < d.psize && (d.loaded = 1, d.data.length || (d.empty = 1)), e.data.categorySelectedId = a.cid, 
                    e.data.childSelectedId = a.child_id, e.data.goodsAll[e.data.categorySelectedIndex] = [], 
                    e.data.goodsAll[e.data.categorySelectedIndex][e.data.childSelectedIndex] = d, e.setData({
                ...
                if (e.onCalculate(), e.data.store.data.wxapp) {
                    var i = e.data.store.data.wxapp.extPages;
                    if (i) {
                        var s = i.pages_store_goods.navigationBarBackgroundColor;
        ...
        t.util.request({
            ...
            success: function(a) {
                ...
                if (!1 !== u) {
                    ...
                    if (d.totalnum++, d.options_data[m.option_id].num ? d.options_data[m.option_id].num++ : d.options_data[m.option_id].num = 1, 
                    1 != d.is_options && 1 != d.is_attrs || (d.activeOption.num = d.options_data[m.option_id].num), 
                    ...
                    o = {
                        ...
                        var i = e.data.cateHasGoods;
                        o.goodsActive = d, i[r].goods[n] = d, o.cateHasGoods = i;
                    }
                }
    ...
    onSubmit: function() {
      ...
      var e = "pages/order/create/create?sid=" + a.data.store.id + "&is_buysvip=" + a.data.cart.is_buysvip;
        ...
        t.util.request({
            ...
            success: function(a) {
                ...
                if (!1 !== g) {
                    ...
                    if (s.totalnum > 0 && s.totalnum--, s.options_data[p.option_id].num ? s.options_data[p.option_id].num-- : s.options_data[p.option_id].num = 0, 
                    1 != s.is_options && 1 != s.is_attrs || (s.activeOption.num = s.options_data[p.option_id].num), 
                    1 == e.data.template_page) "detail" == i && (e.data.goodsDetail.totalnum ? e.data.goodsDetail.totalnum-- : e.data.goodsDetail.totalnum = 0), 
                    e.data.goodsAll[e.data.categorySelectedIndex][e.data.childSelectedIndex].data[d] = s, 
                    o = {
                        cart: a.message.cart,
                        goodsAll: e.data.goodsAll,
                        goodsItem: e.data.goodsAll[e.data.categorySelectedIndex][e.data.childSelectedIndex],
                        ...
                        var n = e.data.cateHasGoods;
                        o.goodsActive = s, n[l].goods[d] = s, o.cateHasGoods = n;
                    }
                }
