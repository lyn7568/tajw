...
util.imessage = function(e, t, a) {
    var n = {};
    if (t) {
        var i = t.substring(0, 9), s = "", r = "";
        "navigate:" == i ? (r = "navigate", s = t.substring(9)) : "redirect:" == i ? (r = "redirect", 
        s = t.substring(9)) : "switchTab:" == t.substring(0, 10) ? (r = "switchTab", s = t.substring(10)) : (r = "redirect", 
        s = t);
    }
    ...
    var n = getCurrentPages(), i = n[n.length - 1], s = i.data.wuiToast || {};
    clearTimeout(s.timer), i.setData({
        wuiToast: {
            show: !0,
            title: e,
            url: t
    ...
    return wx.getSetting({
        success: function(e) {
            if (!e.authSetting["scope.userInfo"]) return util.showOauth(), !1;
        }
    }), !0;
}, util.jsInfinite = function(e) {
    var t = util.getCurPage(), a = e.currentTarget.dataset, n = a.min, i = a.href, s = a.name;
        ...
        success: function(e) {
            var t = e.data.message;
            {
                if (!t.errno) {
                    ...
                    return n[s] = a, e.data.message.min || (n.min = -1), that.setData(n), !0;
                }
    ...
    wx.removeStorageSync("location"); else if ("jsOauth" == t) {
        util.hideOauth(), console.log(e);
        var n = e.detail, i = {};
        "getUserInfo:ok" == n.errMsg ? util.request({
            showLoading: !1,
    ...
    return !!t && (1 == (t = t.split(":")).length ? (t = 0 == t[0].indexOf("/") ? t[0] : "/" + t[0], 
    void wx.navigateTo({
        url: t,
        fail: function(e) {
    ...
    })) : void ("webview" == t[0] ? util.webview(e) : "tel" == t[0] ? util.jsPhone(e) : "miniProgram" == t[0] ? util.jsMiniProgram(e) : "wx" == t[0] && "scanCode" == t[1] && wx.scanCode({
        success: function(e) {
  ...
  return 0 == e.indexOf("./") ? t.siteMain.sitebase + "/" + e.replace("./", "") : "";
    ...
    var t = e.currentTarget.dataset, a = t.key, n = t.index, i = util.getCurPage(), s = i.data[a];
    s.splice(n, 1);
    var r = {};
    r[a] = s, i.setData(r);
    ...
    var t = e.currentTarget.dataset, a = util.getCurPage(), n = t.modal, i = t.modal.split("."), s = {};
    if (1 == i.length) s[n] = !a.data[n], a.setData(s); else {
        var r = !a.data[i[0]][i[1]];
        s[n] = r, a.setData(s);
    }
    return !0;
    ...
    var t = e.currentTarget.dataset, a = t.confirm, n = t.href || t.url, i = t.successUrl, s = util.getCurPage(), r = function() {
        s.data.jspost && 1 == s.data.jspost || (s.data.jspost = 1, util.showLoading(), i || (i = "refresh"), 
        util.request({
            url: util.url(n),
            data: {},
            success: function(e) {
                s.data.jspost = 0, wx.hideLoading();
    ...
    if (1 == n.length) wx.setStorageSync(e, t); else if (2 == n.length) (s = wx.getStorageSync(n[0])) || (s = {}), 
    s[n[1]] = t, wx.setStorageSync(n[0], s); else if (3 == n.length) {
        var s = wx.getStorageSync(n[0]);
        s || (s = {}), s[n[1]] || (s[n[1]] = {}), s[n[1]][n[2]] = t, wx.setStorageSync(n[0], s);
    }
    return !0;
  ...
  if (t && t.siteMain || (t = getApp().ext), !e) return t;
    ...
    util.request({
        ...
        success: function(n) {
            ...
            if (i && (i = "/" + i, s.url_detail = i), "wechat" == e.pay_type) return wx.requestPayment({
                ...
                paySign: n.paySign,
                success: function(t) {
                    return "function" == typeof e.success ? (e.success(t), !1) : s ? (util.toast("支付成功", s.url_detail, 3e3), 
                    !1) : void 0;
                },
                fail: function(t) {
            ...
            !1;
            return !!s && (util.toast("支付成功", s.url_detail, 3e3), !0);
        }
    });
  ...
  n = a.siteMain.siteroot + "?i=" + a.siteMain.uniacid + "&v=" + a.siteMain.version + "&m=we7_wmall&c=entry&do=mobile&";
    ...
    (t = "object" === (void 0 === t ? "undefined" : _typeof(t)) ? t : {}) && "object" === (void 0 === t ? "undefined" : _typeof(t))) for (var s in t) s && t.hasOwnProperty(params) && t[s] && (n += s + "=" + t[s] + "&");
    return n += "&from=wxapp";
    ...
    e.data || (e.data = {}), 1 != e.data.forceOauth || t) {
        ...
        wx.showNavigationBarLoading(), e.showLoading && util.showLoading(), console.log(a), 
        wx.request({
            url: a,
            data: e.data ? e.data : {},
            ...
            success: function(t) {
                ...
                if (t.data && t.data.global) {
                    ...
                    if (a.configmall && a.configmall.logo && (n.logo = a.configmall.logo), a.configmall && a.configmall.title && (n.title = a.configmall.title), 
                    util.setStorageSync("mallBasic", n), 1 == e.data.menufooter && a.menufooter) {
                        var i = a.menufooter.data;
                        i && util.setNavigator(i, {
                            bottom: "80px"
                        });
                    }
                }
                    ...
                    success: function(a) {
                      console.log(a)
                        ...
                        wx.getUserInfo({
                            ...
                            fail: function(e) {
                                console.log("失败失败失败失败失败失败失败失败失败失败失败失败"), console.log(e), e && ("getUserInfo:fail scope unauthorized" == e.errMsg ? util.showOauth() : "getUserInfo:fail auth deny" == e.errMsg && wx.showModal({
                                    title: "授权提示",
                                    content: "若需登录平台，平台需要获取您的公开信息（昵称、头像等）",
                                    confirmText: "授权",
                                    showCancel: !1,
    ...
    wx.getLocation({
        ...
        fail: function(e) {
            console.log("定位失败："), console.log(e), e && ("getLocation:fail auth deny" == e.errMsg || "getLocation:fail:auth denied" == e.errMsg ? wx.showModal({
                title: "授权提示",
                ...
                content: "亲,你没有给微信APP授权定位权限,请在授权后下拉刷新进入平台！",
                showCancel: !1
            }));
        }
    });
    ...
    e = e.title), t) {
        ...
        "navigate:" == n ? (s = "navigateTo", i = t.substring(9)) : "redirect:" == n ? (s = "redirectTo", 
        i = t.substring(9)) : (i = t, s = "redirectTo");
    }
    ...
    this.isLeapYear = function(e) {
        ...
        var s = 0;
        (n = e.indexOf("MM")) > -1 && n < i && (s = parseInt(t.substr(n, 2)) - 1);
        var r = 0;
        (n = e.indexOf("dd")) > -1 && n < i && (r = parseInt(t.substr(n, 2)));
        var o = 0;
        ((n = e.indexOf("HH")) > -1 || (n = e.indexOf("hh")) > 1) && n < i && (o = parseInt(t.substr(n, 2)));
        var u = 0;
        (n = e.indexOf("mm")) > -1 && n < i && (u = t.substr(n, 2));
        var l = 0;
        return (n = e.indexOf("ss")) > -1 && n < i && (l = t.substr(n, 2)), new Date(a, s, r, o, u, l);
        ...
        if (-1 == i) return !1;
        var s = e.substring(i, i + 2), r = t.indexOf("dd");
        if (-1 == r) return !1;
        var o = e.substring(r, r + 2);
        return !(!isNumber(n) || n > "2100" || n < "1900") && (!(!isNumber(s) || s > "12" || s < "01") && !(o > getMaxDay(n, s) || o < "01"));
