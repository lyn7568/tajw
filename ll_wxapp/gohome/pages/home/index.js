    ...
    onLoad: function() {
        ...
        a.util.request({
            ...
            success: function(e) {
                ...
                0 == t.data.tongcheng.data.length && (t.data.tongcheng.empty = 1), delete n.diy.tongcheng, 
                n.diy.tongcheng = t.data.tongcheng);
                var i = {};
                n.diy.is_has_location && (i = a.util.getStorageSync("location")), n.location = i;
                var s = n.diy.data.items;
                for (var g in s) "richtext" == s[g].id && a.WxParse.wxParse("richtext." + g, "html", s[g].params.content, t, 5);
                ...
                var d = n.diy.guide;
                d && (d && "everytime" == d.params.show_setting && a.util.getStorageSync("storage") && (t.setData({
                    has_diy_guide: !0
                }), a.util.setStorageSync("storage", {}, 0)), n.storage = a.util.getStorageSync("storage"), 
                !d || "interval" != d.params.show_setting || n.storage && n.storage.storageGuide || a.util.setStorageSync("storage", {
                    storageGuide: 1
                }, 60 * d.params.interval_time)), t.setData(n);
            }
        });
    },
