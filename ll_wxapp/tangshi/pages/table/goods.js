    ...
    onPindan: function(a) {
        ...
        t.util.request({
            ...
            success: function(t) {
                ...
                var o = {
                    "pindan.status": 1,
                    mergeOrder: a.message
                };
                console.log("99999999999999"), console.log(o), e.setData(o);
            }
        });
    },
    onLoad: function(a) {
        ...
        a.cart_id && (e.data.pindan.cart_id = a.cart_id);
        ...
        t.util.request({
            ...
            success: function(o) {
                var d = {
                    ...
                    psize: 30,
                    empty: 0,
                    data: (o = o.data.message.message).goods,
                    orderby: {
                        type: "",
                        value: ""
                    }
                };
                if (d.data.length < d.psize && (d.loaded = 1, d.data.length || (d.empty = 1)), e.data.categorySelectedId = o.cid, 
                e.data.childSelectedId = o.child_id, e.data.goodsAll[e.data.categorySelectedIndex] = [], 
                e.data.goodsAll[e.data.categorySelectedIndex][e.data.childSelectedIndex] = d, e.data.store = o.store, 
