    ...
    onPlus: function(a) {
        ...
        t.util.request({
            ...
            success: function(a) {
                ...
                r.goods_id == i.id && (i.totalnum++, i.options_data[r.option_id].num ? i.options_data[r.option_id].num++ : i.options_data[r.option_id].num = 1, 
    ...
    onMinus: function(a) {
        ...
        t.util.request({
            ...
            success: function(a) {
                if ((a = a.data.message).errno) return t.util.toast(a.message), !1;
                var i = o.data.goodsActive;
                r.goods_id == i.id && (i.totalnum > 0 && i.totalnum--, i.options_data[r.option_id].num ? i.options_data[r.option_id].num-- : i.options_data[r.option_id].num = 0, 
                r.option_id != i.activeOptionId || 1 != i.is_options && 1 != i.is_attrs || (i.activeOption.num = i.options_data[r.option_id].num), 
                ...
                a.message.cart.num || (e.showCartDetail = !1), o.setData(e), o.onCalculate();
            }
        });
    },
