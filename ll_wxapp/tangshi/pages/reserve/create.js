...
Page({
    ...
    onLoad: function(a) {
        ...
        t.util.request({
            ...
            data: o,
            success: function(s) {
                s = (s = s.data.message).message, r.data.extra.reserve_type || (r.data.extra.reserve_type = "table"), 
                r.data.extra.username || (r.data.extra.username = s.order.username), r.data.extra.mobile || (r.data.extra.mobile = s.order.mobile), 
                r.setData({
                    store: s.store,
                    cart: s.cart,
                    category: s.category,
